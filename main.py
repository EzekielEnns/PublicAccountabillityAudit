...
#storeage will be hdF5
#https://github.com/telegraphic/hickle
#https://github.com/telegraphic/hickle#dumping-custom-objects
@dataclass
class Comment:
...
#so this is a unstable way to get them https://github.com/jdepoix/youtube-transcript-api
#from youtube_transcript_api import YouTubeTranscriptApi
#test = YouTubeTranscriptApi.get_transcript('T1MWP87Hdk4')
...
api_version = "v3"
#TODO add with for errr halding 
